# Journal — Jeudi 10 Septembre 2026 (rédigé par:BOURAÏMA OM0NBA MOUBARAK )
...
![essai de realisation du circuit pour le coffre dans Kicad]
...
![code micropython pour le test du clavier matriciel]
...
![code micropython pour le test du solenoide]
...
* [ ] Poursuivre et finaliser la modélisation 3D du boîtier de protection du PCB 
* [ ] Rédiger le programme MicroPython d'analyse du code PIN et d'activation automatisée du solénoïde 
* [ ] Réaliser le test d'ouverture