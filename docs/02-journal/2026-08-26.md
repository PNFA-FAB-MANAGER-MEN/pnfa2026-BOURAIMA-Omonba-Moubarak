...
* La diversité des ateliers rendait difficile la découverte simultanée de toutes les activités → organisation des participants en **4 groupes** avec une rotation entre les ateliers → cue groupe peut ainsi découvrir progressivement les différents domaines.
